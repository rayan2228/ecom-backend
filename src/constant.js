...
export { PORT, DBURL, JWT_SECRET, ACCESSTOKEN_EXPIRE, ACCESSTOKEN_SECRET, REFRESHTOKEN_EXPIRE, REFRESHTOKEN_SECRET,CLOUD_API_KEY,CLOUD_NAME,CLOUD_API_SECRET,origin }